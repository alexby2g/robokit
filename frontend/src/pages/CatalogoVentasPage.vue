            ...
            <div class="col-12 col-md-6">
              <q-card flat class="payment-box q-pa-md">
                <div class="row items-center no-wrap q-gutter-md">
                  <q-avatar color="purple-9" text-color="white" icon="qr_code_2" size="58px" />
                  <div>
                    <div class="text-weight-bold">Pago únicamente por QR</div>
                    <div class="text-caption text-grey-4">Primero solicita el pedido. Luego podrás ampliar o descargar el QR y subir el comprobante para verificación.</div>
                  </div>
                </div>
              </q-card>
            </div>
